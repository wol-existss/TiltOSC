...
controller_enabled = config.get("controller_enabled", True)

# Wheel calibration
wheel_angle_offset = config.get("wheel_angle_offset", 0.0)
wheel_angle_scale = config.get("wheel_angle_scale", 1.0)
